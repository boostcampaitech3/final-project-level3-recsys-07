...
def save_workbooks(workbooks: Tuple[Workbook, ...]) -> None:
    ...
    workbooks[0].save("./asset2/item.xlsx")
    workbooks[1].save("./asset2/item_color.xlsx")
    workbooks[2].save("./asset2/item_size.xlsx")
    workbooks[3].save("./asset2/item_tag.xlsx")
    workbooks[4].save("./asset2/item_four_season.xlsx")
    workbooks[5].save("./asset2/item_fit.xlsx")
    workbooks[6].save("./asset2/item_buy_age.xlsx")
    workbooks[7].save("./asset2/item_buy_gender.xlsx")
