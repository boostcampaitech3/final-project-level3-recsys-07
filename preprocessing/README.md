...
1. Item Table
    ...
    |:-----:|:-------:|:---------:|:-------------------------:|:---:|
    |Item   |id       | 아이템 ID   |<span style="color:red">X</span>|     |
    |Item   |name     | 상품명      |<span style="color:red">X</span>|     |
    |Item   |big_class| 대분류      |<span style="color:red">X</span>| 유사한 대분류 통일, 악세사리 및 기타 대분류 제거 |
    |Item   |mid_class| 중분류      |<span style="color:red">X</span>| 유사한 중분류 통일     |
    |Item   |brand    | 브랜드      |<span style="color:red">X</span>|      |
    |Item   |serial_number| 품번    |<span style="color:red">X</span>|      |
    |Item   |price    | 가격        |<span style="color:red">X</span>|      |
    |Item   |likes    | 좋아요 수    | 0                         |   |
    |Item   |R, G, B  | 색상 R, G, B|<span style="color:red">X</span>| 이미지에서 가장 높은 비율을 차지하는 색상의 R, G, B 값 추출|
    ...
    |Item   |color_id| 색상 아이디    |<span style="color:red">X</span>| R, G, B 값을 활용해 클러스터링 |
    |Item   |cluster_id|클러스터 아이디 |<span style="color:red">X</span>| 중분류와 색상을 활용해 클러스터링 |
    |Item   |img_url   |이미지 주소   |<span style="color:red">X</span>|         |
    |Item   |url       |상품 페이지 주소|<span style="color:red">X</span>|         |
